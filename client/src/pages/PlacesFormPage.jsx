    ...
    return (
        <div>
            ...
            <form onSubmit={savePlace}>
                ...
                {preInput('Check in and Check out times, max guests','Add the check in and out times, remember to have some time window for cleaning the room')}
                <div className="grid gap-2 grid-cols-2 md:grid-cols-4">
                    <div>
                        <h3 className="mt-2 -mb-1">Check in time</h3>
                        <input type="text" value={checkIn} onChange={ev => setCheckIn(ev.target.value)} placeholder="16"/> 
                    </div>
                    <div>
